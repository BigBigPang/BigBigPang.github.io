...
1. 用别人的Shadowsocks: 
如果你有懂技术的朋友愿意和你分享Shadowsocks账号，你可以使用。

2. 购买Shadowsocks:
从ss服务商那里购买搭建好的节点，俗称「机场」，目前绝大多数机场提供节点都解锁了 Netflix 和 HBO。比较知名的一些机场有 Rixcloud、魅影极速、Dler Cloud等等。
...
![](https://i.loli.net/2019/05/04/5ccd5edad4917.jpg)

   2.我们需要先添加SSR服务器。右键点击小飞机——服务器——编辑服务器：
   
![](https://i.loli.net/2019/05/04/5ccd5efe5fc6c.jpg)
   ...
   ***混淆参数：***输入一个国外常用网址，比如cloudflare.com，或者也可以留空。

   设置完成后，点击确定即可完成服务器的设置。

![](https://i.loli.net/2019/05/04/5ccd5f1479717.jpg)

   当然，你还可以通过扫描节点二微码或是导入URL的方式来添加节点，更为方便：
   
![](https://i.loli.net/2019/05/04/5ccd6a04c1e1f.png)
  
   如果你购买了机场，获得了订阅链接，可以通过订阅的方式批量添加并更新节点信息：右击任务栏小飞机图标-服务器订阅-SSR服务器订阅设置，点击“delete”将自带订阅删除（自带订阅早已失效，已经不需要了）。SSR 的任务栏图标（纸飞机样子的图标，下文均简称为“小飞机”），右击小飞机-服务器订阅-SSR服务器订阅设置，点击“delete”将自带订阅删除（自带订阅早已失效，已经不需要了）。然后就可以将你的订阅链接添加进去。
   
![](https://i.loli.net/2019/05/04/5ccd6ba177751.png)
![](https://i.loli.net/2019/05/04/5ccd6ba1aa4bf.png)

   然后继续右键点击小飞机，选择“服务器订阅-更新SSR服务器订阅（不通过代理）”

![](https://i.loli.net/2019/05/04/5ccd6c08382bd.png)

   更新成功后，服务器里面就会出现你可用的服务器列表，选择你喜欢的节点即可。
...
**到这里你应该就可以正常观看你喜爱的影片了。**

**文中内容如果有什么不正确的或是你还有什么疑问，欢迎在下方留言。祝各位观影愉快！**
